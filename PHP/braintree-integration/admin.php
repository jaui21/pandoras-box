							...
							<table class="payments-table table table-striped table-hover mt10">
								...
								<tbody>
									...
									<tr>
										...
										<td>
											<?php echo $payment->braintree_transaction_id ? 'Braintree' : ($payment->paypal_transaction_id ? 'PayPal' : ''); ?>
										</td>
										<td>
											<?php echo $payment->braintree_transaction_id ? $payment->braintree_transaction_id : ($payment->paypal_transaction_id ? $payment->paypal_transaction_id : ''); ?>
										</td>
										<td>
								...
								<tbody>
									...
									<tr>
										...
										<td>
											...
											$details .= 'Subscription ID: ' . ($subscription->braintree_subscription_id ? $subscription->braintree_subscription_id : ($subscription->paypal_subscription_id ? $subscription->paypal_subscription_id : '')); 
										...
										<td><?php echo $subscription->braintree_subscription_id ? 'Braintree' : ($subscription->paypal_subscription_id ? 'PayPal' : ''); ?></td>
							...
							<div class="row">
								<div class="col-sm-3 config-left">
									<ul class="nav nav-pills nav-stacked nav-pill-control">
										...
										<li role="presentation"><a href="#braintree_info">Braintree Info</a></li>
								...
								<div class="col-sm-9 config-right">
									...
									<form action="<?php echo url('process.php'); ?>" method="post" class="validate form-horizontal">
										...
										<div class="nav-pill-pane" id="general_settings">
											...
											<div class="form-group">
												...
												<div class="col-sm-9">
													...
													<span class="help-block">Select the currency that you want to accept payments in. <span class="colordanger">NOTE:</span> This setting is only used for PayPal payments and to display the correct currency symbol throughout the website.  The actual currency that you accept credit card payments in can only be set within your Braintree merchant account.</span>
												</div>
											</div>
											<div class="form-group">
										...
										<div class="nav-pill-pane" id="subscription_settings">
											<div class="form-group">
												...
												<div class="col-sm-9">
													<select name="config[enable_subscriptions]" class="form-control" data-rule-required="true">
														<option value="braintree_and_paypal" <?php echo $config['enable_subscriptions'] === 'braintree_and_paypal' ? 'selected' : ''; ?>>Braintree &amp; PayPal</option>
														<option value="braintree_only" <?php echo $config['enable_subscriptions'] === 'braintree_only' ? 'selected' : ''; ?>>Braintree Only</option>
											...
											<div class="form-group">
												...
												<div class="col-sm-9">
													...
													<span class="help-block">How often, in months, should customers be charged for subscriptions? <span class="colordanger">NOTE:</span> For Braintree subscriptions, this value must be set for your subscription plan within your Braintree account.</span>
												</div>
											</div>
											<div class="form-group">
												...
												<div class="col-sm-9">
													...
													<span class="help-block">How many billing periods should subscriptions last? For a never ending subscription, enter 0.</span>
												</div>
											</div>
										...
										<div class="nav-pill-pane" id="braintree_info">	
											<div class="form-group">
												<label class="col-sm-3 control-label"><span class="colordanger">*</span>Braintree Environment</label>
												<div class="col-sm-9">
													<select name="config[braintree_environment]" class="form-control" data-rule-required="true">
														<option value="production" <?php echo $config['braintree_environment'] == 'production' ? 'selected' : ''; ?>>Production</option>
														<option value="sandbox" <?php echo $config['braintree_environment'] == 'sandbox' ? 'selected' : ''; ?>>Sandbox</option>
													</select>
													<span class="help-block">Set the environment that you want to use for Braintree payments.</span>
												</div>
											</div>								
											<div class="form-group">
												<label class="col-sm-3 control-label"><span class="colordanger">*</span>Braintree Merchant ID</label>
												<div class="col-sm-9">
													<input type="text" name="config[braintree_merchant_id]" class="form-control" value="<?php echo $config['braintree_merchant_id']; ?>" data-rule-required="true">
													<span class="help-block">Set your Braintree merchant ID.</span>
												</div>
											</div>						
											<div class="form-group">
												<label class="col-sm-3 control-label"><span class="colordanger">*</span>Braintree Public Key</label>
												<div class="col-sm-9">
													<input type="text" name="config[braintree_public_key]" class="form-control" value="<?php echo $config['braintree_public_key']; ?>" data-rule-required="true">
													<span class="help-block">Set your Braintree public key.</span>
												</div>
											</div>						
											<div class="form-group">
												<label class="col-sm-3 control-label"><span class="colordanger">*</span>Braintree Private Key</label>
												<div class="col-sm-9">
													<input type="text" name="config[braintree_private_key]" class="form-control" value="<?php echo $config['braintree_private_key']; ?>" data-rule-required="true">
													<span class="help-block">Set your Braintree private key.</span>
												</div>
											</div>	
											<div class="form-group">
												<label class="col-sm-3 control-label">Braintree Plan ID</label>
												<div class="col-sm-9">
													<input type="text" name="config[braintree_plan_id]" class="form-control" value="<?php echo $config['braintree_plan_id']; ?>">
													<span class="help-block">Set your Braintree Subscription Plan ID.  This is only used if you have enabled Braintree subscriptions.</span>
												</div>
											</div>
											<div class="form-group">
												<div class="col-sm-9 col-sm-offset-3">
										...
										<div class="nav-pill-pane" id="paypal_info">
											<div class="form-group">
												...
												<div class="col-sm-9">
													...
													<span class="help-block">Whether or not to accept PayPal Standard payments in addition to Braintree credit card payments.</span>
												</div>
											</div>	
											<div class="form-group">
